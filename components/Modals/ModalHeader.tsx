    ...
    <div id="myModal" className="modal">
      <div className="modal-content">
        ...
        <ul className="modal__list text16">
          ...
          <li></li>
          <br />
          <li>Напольная акустика</li>
          <li>Полочная акустика</li>
          <li>Встраиваемая акустика</li>
          <li>Dolby.Atmos</li>
          <li>Сабвуферы</li>
          <li>Сетевые проигрыватели</li>
          <li>Проигрыватели винила</li>
          <li>Проекторы и экраны</li>
          <li>Фонокорректоры</li>
          <li>ЦАПы</li>
          <li>Комплекты акустики</li>
          <li>AV Ресиверы</li>
          <li>AV Процессоры</li>
          <li>Предусилители</li>
          <li>Усилители</li>
          <br />
          <li>
            <a href="tel:88007700473">8 (800) 770-04-73</a>
          </li>
